...
import { ChartBarBig, LayoutDashboard, LucideIcon, Settings2, SquareDashedBottomCode, SquareDashedKanban } from "lucide-react";

export default function Dock() {
    return (
        <div className="w-fit flex justify-center items-center gap-4 bg-secondary/40 py-2 px-4 rounded-2xl overflow-hidden motion-blur-in-md motion-preset-slide-up-md
